 ...
 */
namespace Ironedge\TradePass\Block\Adminhtml\Shopcart\Abandoned;
...
class Grid extends \Magento\Reports\Block\Adminhtml\Shopcart\Abandoned\Grid
{
    ...
    public function __construct(
        ...
        \Magento\Reports\Block\Adminhtml\Grid\Shopcart::__construct($context, $backendHelper, $data);
    }
    ...
    {
        \Magento\Reports\Block\Adminhtml\Grid\Shopcart::_construct();
    ...
    protected function _prepareCollection()
    {
        ...
        \Magento\Reports\Block\Adminhtml\Grid\Shopcart::_prepareCollection();
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        \Magento\Reports\Block\Adminhtml\Grid\Shopcart::_addColumnFilterToCollection($column);
        return $this;
    }
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
            ...
            [
                ...
                'index' => 'customer_id',
                'sortable' => false,
                'header_css_class' => 'col-telephone',
                'column_css_class' => 'col-telephone',
				'renderer'  => 'Ironedge\TradePass\Block\Adminhtml\Telephone'
            ]
        );
		$this->addColumn(
            'product_info',
            [
                'header' => __('Product Info'),
                'index' => 'customer_id',
                'sortable' => false,
                'header_css_class' => 'col-product-info',
                'column_css_class' => 'col-product-info',
				'renderer'  => 'Ironedge\TradePass\Block\Adminhtml\Products'
            ]
        );
        ...
        return \Magento\Reports\Block\Adminhtml\Grid\Shopcart::_prepareColumns();
    }
