...
//            echo $customer->getRandomConfirmationKey();exit;    
			...
			$customer->setIsTradepassConfirmed(0);			
           ...
           // $postData['referrer'] = $this->getRequest()->getParam('referrer');
			...
			$postData['is_confirmed'] = 'not_confirmed';
			...
			if(1){
				...
				//$toemail = 'chiragit0007@gmail.com';
				...
				$transport = $this->_transportBuilder->setTemplateIdentifier('tradepass_email_template_admin')
