...
class MassComplete extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction
{
    ...
    public function __construct(Context $context, \Magento\Sales\Model\Order $orderModel, \Magento\Framework\ObjectManagerInterface $objectmanager, Filter $filter, OrderInterface $order, CollectionFactory $collectionFactory, ShipmentFactory $shipmentFactory, InvoiceService $invoiceService, \Magento\Framework\Registry $registry, ShipmentLoader $shipmentLoader)
    {
