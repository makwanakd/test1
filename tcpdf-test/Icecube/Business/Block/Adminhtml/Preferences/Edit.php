...
namespace Icecube\Business\Block\Adminhtml\Preferences;
...
class Edit extends \Magento\Backend\Block\Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->getRequest()->getParam('id', false)) {
            $this->getToolbar()->addChild(
                ...
                'Magento\Backend\Block\Widget\Button',
                [
                    'label' => __('Delete Preference'),
                    'onclick' => 'deleteConfirm('.json_encode(__('Are you sure you want to delete this Preference?')).','. json_encode($this->getDeleteUrl()). ')',
                    'class' => 'delete'
                ]
            );
    ...
    {
        if ($this->getRequest()->getParam('id', false)) {
            return __('Edit  Preference');
        }

        return __('New  Preference');
    }
    ...
    {
        return $this->getLayout()->createBlock('Icecube\Business\Block\Adminhtml\Preferences\Edit\Form')->toHtml();
    }
    /**
