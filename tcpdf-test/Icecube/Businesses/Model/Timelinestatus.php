 ...
 * @link      http://www.icecubedigital.com
 */
class Timelinestatus extends \Magento\Framework\Model\AbstractModel
{
    /**
     * CMS page cache tag
     */
    const CACHE_TAG = 'business_timeline';
    ...
    {
        $this->_init('Icecube\Businesses\Model\ResourceModel\Timelinestatus');
    }
