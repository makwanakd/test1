...
class Pennsylvania extends \Magento\Newsletter\Controller\Subscriber\NewAction
{
        ...
        if (!$post) {
            ...
            if(isset($post['pnpopupemail'])){
		            ...
		            try {
		            	...
		            	$this->messageManager->addSuccess(__('Welcome to the freeboxes family! Please check your email or visit the Login page to log into your account!'));
		            } catch (\Exception $e) {
